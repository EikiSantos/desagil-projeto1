 ...
 */
public class Frase1 extends Fragment {
    ...
    public static Frase1 newInstance(String param1, String param2) {
        Frase1 fragment = new Frase1();
    ...
    public void onViewCreated(View view,Bundle savedInstanceState){
        ...
        buttonFome.setOnClickListener((view2) -> {
            ...
            if (clickcount > 1){
                buttonFome.setBackgroundColor(Color.parseColor("#9459cf"));
                clickcount = 0;
            }
